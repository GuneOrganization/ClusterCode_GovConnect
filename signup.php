...
?>
  ...
  <head>
    ...
    <title>Gov-Connect - Sign Up</title>
    ...
    <div
      ...
      <div class="max-w-sm mx-auto w-full">
        ...
        <div class="space-y-6">
          ...
          <div class="relative">
            <input
              ...
              id="password-pass"
              required />
            <i class="absolute fa-solid password-toggle-pass fa-eye-slash right-0 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600"
              onclick="togglePassword('pass')"></i>
          </div>
          <div class="relative">
            <input
              type="password"
              ...
              id="password-re"
              required />
            <i class="absolute fa-solid password-toggle-re fa-eye-slash right-0 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600"
              onclick="togglePassword('re')"></i>
          </div>
        ...
        <div class="text-center">
          <a href="index.php" class="text-teal-600 font-sm text-sm hover:text-teal-700">

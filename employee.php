                        ...
                        <div class="bg-white shadow rounded-lg overflow-hidden border border-gray-200 flex-1">
                            ...
                            <div class="px-4 py-5 sm:p-6">
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500">Civilian NIC
                                            Number</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-500">Appointment
                                            Purpose</label>
                                    ...
                                    <div>
                                        <label for="status"
                                            class="block text-sm font-medium text-gray-500">Status</label>
                                        <select id="status"
                        ...
                        <div class="bg-white shadow rounded-lg overflow-hidden border border-gray-200 flex-1">
                            ...
                            <div class="px-4 py-5 sm:p-6 space-y-4">
                                ...
                                <div
                                    ...
                                    <button
                                        class="text-green-600 hover:text-green-800 px-3 py-1 rounded-md text-sm font-medium">
                                ...
                                <div class="mb-4 space-y-4 max-h-40 overflow-y-auto p-2">
                                    <div class="flex justify-end">
                                        <div class="max-w-xs md:max-w-md bg-green-100 rounded-lg p-3">
                                            <p class="text-sm text-gray-800">Please bring the original documents for
                                                verification.</p>
                                    ...
                                    <div class="text-center">
                                        <span
                                            class="inline-block bg-gray-100 rounded-full px-3 py-1 text-xs text-gray-500">

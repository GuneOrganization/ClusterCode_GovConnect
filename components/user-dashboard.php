            ...
            <div class="bg-stone-100 rounded-lg shadow p-5">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mb-3">Guidelines and requirements for obtaining
                            a new National Identity Card, including necessary documents, eligibility
                            criteria, and application procedures.</p>
                    ...
                    <button
                        class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded font-medium">VIEW
                        GUIDE</button>
                </div>
            </div>
            <div class="bg-stone-100 rounded-lg shadow p-5">
